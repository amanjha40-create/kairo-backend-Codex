...
def production_settings(**overrides: object) -> Settings:
    values: dict[str, object] = {
        ...
        "hr_portal_base_url": "https://hr.kairoid.com",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"candidate_portal_base_url": "http://candidate.example.com"}, "CANDIDATE_PORTAL_BASE_URL"),
        ({"hr_portal_base_url": "http://hr.kairoid.com"}, "HR_PORTAL_BASE_URL"),
        (
