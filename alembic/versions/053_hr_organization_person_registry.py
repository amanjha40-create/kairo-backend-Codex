...
def upgrade() -> None:
    ...
    person_table = sa.table(
        ...
        sa.column("relationship", relationship_enum),
        sa.column("lifecycle_status", lifecycle_enum),
        sa.column("trust_state", trust_state_enum),
        sa.column("invitation_status_summary", invitation_summary_enum),
        sa.column("verification_status_summary", verification_summary_enum),
        sa.column("passport_status_summary", passport_summary_enum),
    ...
    identifier_table = sa.table(
        ...
        sa.column("organization_id", postgresql.UUID(as_uuid=True)),
        sa.column("identifier_type", identifier_type_enum),
