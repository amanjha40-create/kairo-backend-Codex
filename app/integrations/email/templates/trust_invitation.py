...
def render_trust_invitation(context: TrustInvitationContext) -> TransactionalEmailContent:
    ...
    html_body = render_html(
        ...
        content=(
            ...
            f"<strong>{safe_organization}</strong> invited you to continue a trust verification workflow on KairoID.</p>"
            ...
            "If you did not expect this invitation, do not open the link and contact KairoID support.</p>"
        ),
    )
    text_body = with_text_footer(
        f"Hello {context.subject_name},\n\n"
        f"{context.organization_name} invited you to continue a trust verification workflow on KairoID.\n\n"
        ...
        "If you did not expect this invitation, do not open the link and contact KairoID support."
    )
    return TransactionalEmailContent(
        subject=f"{context.organization_name} invited you to KairoID",
        html_body=html_body,
        text_body=text_body,
    )
