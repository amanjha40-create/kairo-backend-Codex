"""Persistent Trust & Safety investigation history."""
...
class TrustSafetyInvestigationEvent(UUIDPrimaryKeyMixin, Base):
    """Append-only audit trail for Trust & Safety investigations."""

    __tablename__ = "trust_safety_investigation_events"
