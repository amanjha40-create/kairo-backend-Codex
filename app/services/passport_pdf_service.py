...
PDF_FILENAME = "KairoID-Trust-Passport.pdf"
...
def _header(projection: PassportPDFProjection, styles: dict[str, ParagraphStyle]) -> list:
    ...
    return [
        Paragraph("KairoID", styles["brand"]),
...
def _draw_page_frame(pdf_canvas: canvas.Canvas, document: SimpleDocTemplate) -> None:
    ...
    pdf_canvas.setTitle("KairoID Trust Passport")
    pdf_canvas.setAuthor("KairoID")
    ...
    pdf_canvas.drawString(20 * mm, 9.5 * mm, "Private owner export - generated by KairoID")
