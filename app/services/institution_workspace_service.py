...
from app.institution_people.enums import InstitutionPersonLifecycleStatus
...
class InstitutionWorkspaceService:
    ...
    async def dashboard(
        ...
        recent_credentials = sorted(
            (
                ...
                if profile.institution_verification_status == "verified"
    ...
    async def cancel_verification(
        ...
        # Delegate the state transition and audit event to the canonical workflow.
